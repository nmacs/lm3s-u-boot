...
#ifdef CONFIG_ALT_FREQUENCY
# define BAUD_SOURCE_FREQUENCY CONFIG_ALT_FREQUENCY
#else
# define BAUD_SOURCE_FREQUENCY CONFIG_SYSCLK_FREQUENCY
#endif

#define LM3S_BRDDEN     (16 * LM3S_CONSOLE_BAUD)
#define LM3S_BRDI       (BAUD_SOURCE_FREQUENCY / LM3S_BRDDEN)
#define LM3S_REMAINDER  (BAUD_SOURCE_FREQUENCY - LM3S_BRDDEN * LM3S_BRDI)
...
int serial_init(void)
{
   ...
   */
	...
	uart_clock_ctrl(0, SYS_ENABLE_CLOCK);
#endif

#ifndef CONFIG_UART1_DISABLE
  uart_clock_ctrl(1, SYS_ENABLE_CLOCK);;
#endif

#ifndef CONFIG_UART2_DISABLE
  uart_clock_ctrl(2, SYS_ENABLE_CLOCK);
#endif
...
#ifdef CONFIG_ALT_FREQUENCY
	/* Select alternative clock source (POISC) */
	putreg32(UART_UARTCC_CS_ALT, LM3S_CONSOLE_BASE+LM3S_UART_UARTCC_OFFSET);
#endif
